...
typedef struct _FileManager_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } FileManager_MIDL_TYPE_FORMAT_STRING;

typedef struct _FileManager_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } FileManager_MIDL_PROC_FORMAT_STRING;

typedef struct _FileManager_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } FileManager_MIDL_EXPR_FORMAT_STRING;
...
extern const FileManager_MIDL_TYPE_FORMAT_STRING FileManager__MIDL_TypeFormatString;
extern const FileManager_MIDL_PROC_FORMAT_STRING FileManager__MIDL_ProcFormatString;
extern const FileManager_MIDL_EXPR_FORMAT_STRING FileManager__MIDL_ExprFormatString;


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO IFileManager_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IFileManager_ProxyInfo;
...
static const FileManager_MIDL_PROC_FORMAT_STRING FileManager__MIDL_ProcFormatString =
    {
        0,
        {

	/* Procedure sendPathAndPatterns */
...
static const FileManager_MIDL_TYPE_FORMAT_STRING FileManager__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* 1048 */	
			0x13, 0x0,	/* FC_OP */
/* 1050 */	NdrFcShort( 0xffdc ),	/* Offset= -36 (1014) */
...
/* Object interface: IFileManager, ver. 0.0,
   GUID={0x0A7495AD,0x0CC0,0x49F7,{0xB7,0x8A,0x8A,0x8E,0x17,0x81,0x4A,0xCE}} */

#pragma code_seg(".orpc")
static const unsigned short IFileManager_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IFileManager_ProxyInfo =
    {
    &Object_StubDesc,
    FileManager__MIDL_ProcFormatString.Format,
    &IFileManager_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IFileManager_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    FileManager__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(9) _IFileManagerProxyVtbl = 
{
    &IFileManager_ProxyInfo,
    &IID_IFileManager,
    ...
    (void *) (INT_PTR) -1 /* IFileManager::sendPathAndPatterns */ ,
    (void *) (INT_PTR) -1 /* IFileManager::getResult */
};


static const PRPC_STUB_FUNCTION IFileManager_table[] =
{
...
CInterfaceStubVtbl _IFileManagerStubVtbl =
{
    &IID_IFileManager,
    &IFileManager_ServerInfo,
    9,
    &IFileManager_table[-3],
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    FileManager__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _FileManager_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IFileManagerProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _FileManager_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IFileManagerStubVtbl,
    0
};

PCInterfaceName const _FileManager_InterfaceNamesList[] = 
{
    "IFileManager",
    0
};

const IID *  const _FileManager_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _FileManager_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _FileManager, pIID, n)

int __stdcall _FileManager_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_FileManager_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo FileManager_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _FileManager_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _FileManager_StubVtblList,
    (const PCInterfaceName * ) & _FileManager_InterfaceNamesList,
    (const IID ** ) & _FileManager_BaseIIDList,
    & _FileManager_IID_Lookup, 
    1,
    2,
