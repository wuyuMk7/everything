...
Kernel::Kernel(int argc, char **argv)
{
    ...
    quantum = 100;              // Initial value for quantum
...
Kernel::Initialize()
{
    ...
    currentProcess = new Process(0, "Init Process");
    currentProcess->setStatus(PROCESS_RUNNING);

    stats = new Statistics();		// collect statistics
    interrupt = new Interrupt;		// start up interrupt handling
    scheduler = new PriorityScheduler(ProcessComp);	// initialize the ready queue
